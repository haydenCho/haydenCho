...
| Project | Description |
|---|---|
| **sqlgame** | Terminal-based SQL learning game served via `ttyd`, reverse-proxied with Nginx, deployed on AWS EC2 |
| **AWS Resource Cleanup Tool** | `boto3` script that scans and interactively deletes unused AWS resources across all regions |
| **Linux Remote Security Auditor** | Python(Paramiko) + Bash-based tool for remote SSH security checks across servers |
| **WordPress 2-Tier Architecture** | EC2 + RDS deployment practicing VPC, security groups, and DB separation |
| **Youth Center DB Design** | 16-table MariaDB schema design for a community portal service |
...
<a href="https://haydencho.tistory.com/" target="_blank"><img src="https://img.shields.io/badge/Tistory-FF5F00?style=flat&logo=tistory&logoColor=FFFFFF"/></a>
<a href="https://haydencho.tistory.com/" target="_blank"><img src="https://img.shields.io/badge/Portfolio-000000?style=flat&logo=googlechrome&logoColor=FFFFFF"/></a>

![Top Langs](https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=haydenCho&layout=compact)
![Hayden's GitHub stats](https://github-readme-stats-sigma-five.vercel.app/api?username=haydenCho&show_icons=true&theme=graywhite)
